function getCropperLimitsIfHorizontally(imageWidth, imageHeight, W_INT, H_INT, _W, _H, BW, Q) {
    let TOP_LIMIT = 0;
    let LEFT_LIMIT = 0;
    let BOTTOM_LIMIT = 0;
    let RIGHT_LIMIT = 0;
...
function getCropperLimitsIfVertically(imageWidth, imageHeight, W_INT, H_INT, W, H, _BW, Q) {
    let TOP_LIMIT = 0;
    let LEFT_LIMIT = 0;
    let BOTTOM_LIMIT = 0;
    let RIGHT_LIMIT = 0;
...
function getCropperLimits(imageWidth, imageHeight, rotation, W_INT, H_INT, W, H, BW, Q) {
    if (rotation % 180 === 0) {
